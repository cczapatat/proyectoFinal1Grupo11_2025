package com.smartstock.myapplication.products
...
class SearchProductStockOneOkTest {
    ...
    fun searchProductStockOK() {
        ...
        val materialTextView = onView(
            allOf(
                withId(android.R.id.title), withText(Utils.getLocalizedText("menu_consulta_productos")),
                childAtPosition(
                    childAtPosition(
        ...
        onView(withId(R.id.autoCompleteTextViewCreate1)).perform(click())
        ...
        onView(withId(R.id.autoCompleteTextViewCreate2)).perform(click())
        onView(isRoot()).perform(waitFor(200))
        ...
        onView(withId(R.id.buttonSearchProduct))
        ...
        val textView = onView(
            allOf(
                withId(R.id.productListUnits)
            )
        )
        textView.check(matches(isDisplayed()))

        onView(withId(R.id.buttonCancelCreate))
            .check(matches(isDisplayed()))
            .check(matches(isEnabled()))
            .perform(click())
