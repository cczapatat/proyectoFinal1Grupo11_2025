...
services="client document_manager manufacture_api manufacturers_worker massive_worker order product products_worker route seller stocks_api stocks_worker stores user_session_manager video_manager_api video_recommendations_worker visit web-smartstock"
