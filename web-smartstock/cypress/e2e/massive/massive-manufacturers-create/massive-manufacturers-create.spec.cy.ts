describe('Create Massive Manufacturers Test', () => {
  beforeEach(() => {
    cy.login('admin.admin@sta.com', '123456');
    cy.navigateToMassiveManufacturersCreate();
  });

  it('Show Create Massive Manufacturers Form Components', () => {
    cy.wait(1000);
    cy.contains('Registro Masivo de Fabricantes');
  ...
  it('Upload CSV File Success', () => {
    const fileName = 'manufacturers.csv';
