describe('Update Massive Products Test', () => {
  beforeEach(() => {
    cy.login('admin.admin@sta.com', '123456');
    cy.navigateToMassiveProductsEdit();
  });

  it('Show Edit Massive Products Form Components', () => {
    cy.wait(1000);
    cy.contains('Edición Masiva de Productos');
  ...
  it('Upload CSV File Success', () => {
    const fileName = 'products-update.csv';
