...
describe('SalesPeopleRegisterComponent', () => {
  let component: SalesPeopleRegisterComponent;
  let fixture: ComponentFixture<SalesPeopleRegisterComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [SalesPeopleRegisterComponent, DummyComponent],
      imports: [
        ReactiveFormsModule,
        RouterTestingModule.withRoutes([{ path: 'salespeople/login', component: DummyComponent }]),
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SalesPeopleRegisterComponent);
